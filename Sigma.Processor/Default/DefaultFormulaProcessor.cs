...
namespace Sigma.Processor
{
    ...
    public class DefaultFormulaProcessor : IFormulaProcessor
    {
        ...
        {
            Language = language;
            LanguageDefinition = LanguageDefinitionRepository
                .Instance
        ...
        private string RepresentLogical(Logical logical)
        {
            ...
            var definition = LanguageDefinition
                .GetLogicalOperator(Specification.Specification.MapOpCode(logical.OpCode));
        ...
        private string RepresentPredicate(Predicate predicate)
        {
            ...
            var definition = LanguageDefinition
                .GetPredicateOperator(Specification.Specification.MapOpCode(predicate.OpCode));
